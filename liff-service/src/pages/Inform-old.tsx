...
export default function Inform() {
    ...
    //     const result = await (liff.getOS() === "ios" ? liff.scanCodeV2?.() : liff.scanCode?.());
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            alert("uuid_qr: " + uuid + "\n" +
                ...
                "user_name: " + userName + "\n" +
                "group_id: " + groupID);
            alert("permission: " + JSON.stringify(liff.permission.query("chat_message.write")));
